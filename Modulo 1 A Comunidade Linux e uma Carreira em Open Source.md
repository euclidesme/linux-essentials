...
1. [Evolução do Linux e Sistemas Operacionais Populares](#11-evolução-do-linux-e-sistemas-operacionais-populares)
   - [Introdução ao Linux](#introdução-ao-linux)
   - [Distribuições Linux](#distribuições-linux)
   - [Sistemas Embarcados](#sistemas-embarcados)
   - [Linux e a Nuvem](#linux-e-a-nuvem)

2. [Principais Aplicações de Código Aberto](#principais-aplicações-de-código-aberto)
   - [Pacotes de Software](#pacotes-de-software)
   - [Gerenciamento de Pacotes](#gerenciamento-de-pacotes)
   - [Aplicações para Escritório](#aplicações-para-escritório)
   - [Navegadores Web](#navegadores-web)
   - [Aplicações Multimídia](#aplicações-multimídia)
   - [Aplicações para Servidores](#aplicações-para-servidores)
   - [Compartilhamento de Dados](#compartilhamento-de-dados)
   - [Administração de Rede](#administração-de-rede)
   - [Linguagens de Programação](#linguagens-de-programação)

3. [Software de Código Aberto e Licenciamento](#software-de-código-aberto-e-licenciamento)
   - [Definição de Software Livre e de Código Aberto](#definição-de-software-livre-e-de-código-aberto)
   - [Licenças](#licenças)
   - [Modelos de Negócio em Código Aberto](#modelos-de-negócio-em-código-aberto)

4. [Habilidades de TIC e Trabalhando com Linux](#habilidades-de-tic-e-trabalhando-com-linux)
   - [Interfaces do Usuário Linux](#interfaces-do-usuário-linux)
   - [Usos Industriais do Linux](#usos-industriais-do-linux)
   - [Privacidade na Internet](#privacidade-na-internet)
...
Cada distribuição é criada com objetivos específicos:
...
**Interfaces Gráficas**
Todas as distribuições modernas oferecem também interfaces gráficas para gerenciar pacotes, como:
...
Muitas pessoas se perguntam: "Como as empresas ganham dinheiro com software livre?" Existem vários modelos de negócio viáveis:
